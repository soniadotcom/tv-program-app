...
import static java.util.Comparator.*;
    ...
    public class ProgramSorters {
        ...
        static {
            sorters = new HashMap<>();
            sorters.put(ProgramSortCriteria.OLD_FIRST, comparing(Program::getProgramId));
            sorters.put(ProgramSortCriteria.NEW_FIRST, comparing(Program::getProgramId, reverseOrder()));
